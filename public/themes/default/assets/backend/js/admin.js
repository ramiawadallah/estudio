...
$(document).ready(function()
{
    ...
    ({
        weekStart: 0, format: 'DD MMM, YYYY - hh:ii'
    });
    $('#date-start').bootstrapMaterialDatePicker
    ({
        weekStart: 0, format: 'DD MMM, YYYY - hh:ii', shortTime : true
    }).on('change', function(e, date)
    {
        $('#date-end').bootstrapMaterialDatePicker('setMinDate', date);
    });

    $('#min-date').bootstrapMaterialDatePicker({ format : 'DD MMM, YYYY - hh:ii', minDate : new Date() });

...
{!! bsForm::start(['route'=>['admin.teams.update',$team->id],'method'=>'put','enctype'=>'multipart/form-data']) !!}
...
<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
    ...
    {!! bsForm::translate(function($form,$lang) use($team){
        ...
        $form->textarea('content',$team->trans('content',$lang),['class'=>'editor form-control']);

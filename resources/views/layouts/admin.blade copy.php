...
<head>
	...
	<link rel="stylesheet" href="{{ theme('backend/js/jquery-ui/css/no-theme/jquery-ui-1.10.3.custom.min.css') }}">
	<link rel="stylesheet" href="{{ theme('backend/css/font-icons/entypo/css/entypo.css') }}">
	<link rel="stylesheet" href="{{ theme('backend/css/bootstrap.css') }}">
	<link rel="stylesheet" href="{{ theme('backend/css/neon-core.css') }}">
	<link href="https://fonts.googleapis.com/css?family=Cairo" rel="stylesheet">
	<link rel="stylesheet" href="{{ theme('backend/css/skins/white.css') }}">
	...
	<link rel="stylesheet" href="{{ theme('backend/css/neon-forms.css') }}">
	<link rel="stylesheet" href="{{ theme('backend/css/custom.css') }}">

	<script src="{{ theme('backend/js/tinymce/tinymce.min.js') }}"></script>

	<script src="{{ theme('backend/js/jquery-1.11.3.min.js') }}"></script>
...
@endif()
	...
	<link rel="stylesheet" href="{{ theme('backend/js/jvectormap/jquery-jvectormap-1.2.2.css') }}">
	<link rel="stylesheet" href="{{ theme('backend/js/rickshaw/rickshaw.min.css') }}">
	<link rel="stylesheet" href="{{ theme('backend/js/datatables/datatables.css') }}">
	<link rel="stylesheet" href="{{ theme('backend/js/icheck/skins/minimal/_all.css') }}">
	<link rel="stylesheet" href="{{ theme('backend/js/icheck/skins/square/_all.css') }}">
	<link rel="stylesheet" href="{{ theme('backend/js/icheck/skins/flat/_all.css') }}">
	<link rel="stylesheet" href="{{ theme('backend/js/icheck/skins/futurico/futurico.css') }}">
	<link rel="stylesheet" href="{{ theme('backend/js/icheck/skins/polaris/polaris.css') }}">
	<link rel="stylesheet" href="{{ theme('backend/js/icheck/skins/line/_all.css') }}	">

	<!-- Bottom scripts (common) -->
	<script src="{{ theme('backend/js/gsap/TweenMax.min.js') }} "></script>
	<script src="{{ theme('backend/js/jquery-ui/js/jquery-ui-1.10.3.minimal.min.js') }}"></script>
	<script src="{{ theme('backend/js/bootstrap.js') }}"></script>
	<script src="{{ theme('backend/js/joinable.js') }} "></script>
	<script src="{{ theme('backend/js/resizeable.js') }}"></script>
	<script src="{{ theme('backend/js/neon-api.js') }}"></script>
	<script src="{{ theme('backend/js/jvectormap/jquery-jvectormap-1.2.2.min.js') }}"></script>
	<script src="{{ theme('backend/js/bootstrap-switch.min.js') }}"></script>
	
	<!-- Imported scripts on this page -->
	<script src="{{ theme('backend/js/jvectormap/jquery-jvectormap-europe-merc-en.js') }}"></script>
	<script src="{{ theme('backend/js/jquery.sparkline.min.js') }}"></script>
	<script src="{{ theme('backend/js/rickshaw/vendor/d3.v3.js') }}"></script>
	<script src="{{ theme('backend/js/rickshaw/rickshaw.min.js') }}"></script>
	<script src="{{ theme('backend/js/raphael-min.js') }}"></script>
	<script src="{{ theme('backend/js/morris.min.js') }}"></script>
	<script src="{{ theme('backend/js/toastr.js') }}"></script>
	<script src="{{ theme('backend/js/neon-chat.js') }}"></script>
	<script src="{{ theme ('backend/js/datatables/datatables.js') }}"></script>

	<!-- JavaScripts initializations and stuff -->
	<script src="{{ theme('backend/js/neon-custom.js') }}"></script>

	<!-- Demo Settings -->
	<script src="{{ theme('backend/js/neon-demo.js') }}"></script>

	<script src="{{ theme('backend/js/fileinput.js') }}"></script>
	<script src="{{ theme('backend/js/dropzone/dropzone.js') }}"></script>
	<script src="{{ theme('backend/js/neon-chat.js') }}"></script>
	<script src="{{ theme('backend/js/icheck/icheck.js') }}""></script>


	<script src="{{ theme('backend/js/select2/select2.min.js') }}"></script>
	<script src="{{ theme('backend/js/bootstrap-tagsinput.min.js') }}"></script>
	<script src="{{ theme('backend/js/typeahead.min.js') }}"></script>
	<script src="{{ theme('backend/js/selectboxit/jquery.selectBoxIt.min.js') }}"></script>
	<script src="{{ theme('backend/js/bootstrap-timepicker.min.js') }}"></script>
	<script src="{{ theme('backend/js/bootstrap-datepicker.js') }}"></script>
	<script src="{{ theme('backend/js/bootstrap-colorpicker.min.js') }}"></script>
	<script src="{{ theme('backend/js/daterangepicker/daterangepicker.js') }}"></script>
